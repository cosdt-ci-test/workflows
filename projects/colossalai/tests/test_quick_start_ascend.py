"""Quick-start-Ascend documentation test for ColossalAI.

Document under test: ``projects/colossalai/docs/Quick-start-Ascend.md``.
"""
...
class TestQuickStartAscend(MarkdownDocTestBase, unittest.TestCase):
    ...
    def prepare_environment(cls) -> None:
        ...
        probe = subprocess.run(
            [
                'python', '-c',
                'import torch, torch_npu; raise SystemExit('
