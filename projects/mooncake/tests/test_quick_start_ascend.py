...
Document under test: ``projects/mooncake/docs/Quick-start-Ascend.md``
...
class TestQuickStartAscend(MarkdownDocTestBase, unittest.TestCase):
    ...
    def prepare_environment(cls) -> None:
        ...
        CANN keys overwrite the container defaults (including
        ``LD_LIBRARY_PATH``); CI-injected names in ``_PRESERVE_ENV`` stay.
        """
