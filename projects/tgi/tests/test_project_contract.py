...
class TestTgiProjectContract(unittest.TestCase):
    def test_project_registry_points_to_the_quick_start_workflow(self) -> None:
        ...
        project = projects[0]
        self.assertEqual(
            project["upstream_repo"], "VenusTZZ/text-generation-inference"
        )
    ...
    def test_workflow_file_exists_and_uses_the_shared_engine(self) -> None:
        ...
        self.assertIn("VenusTZZ/text-generation-inference", workflow)
    ...
    def test_doc_contains_the_expected_flow(self) -> None:
        ...
        required_fragments = (
            ...
            "| transformers | 4.57.6 |",
            "| kernels | 0.5.0 |",
            # the fork under guard + tag checkout
            "https://github.com/VenusTZZ/text-generation-inference.git",
