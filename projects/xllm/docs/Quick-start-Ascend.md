...
swr.cn-south-1.myhuaweicloud.com/ascendhub/xllm:v0.10.1-ascend
...
> 说明：CI 使用 xllm 官方 NPU 镜像 `swr.cn-south-1.myhuaweicloud.com/ascendhub/xllm:v0.10.1-ascend`，**已预装 xllm v0.10.1 及其依赖**（含 torch 2.9.0、torch_npu 2.9.0.post2、CANN 9.1.0 运行时），无需从源码编译，启动即用。
